...
HeadingAnimation::HeadingAnimation(QObject *target, const QByteArray &propertyName, QObject *parent)
    : QPropertyAnimation(target, propertyName, parent)
{
}

void HeadingAnimation::updateCurrentValue ( const QVariant & value )
{
